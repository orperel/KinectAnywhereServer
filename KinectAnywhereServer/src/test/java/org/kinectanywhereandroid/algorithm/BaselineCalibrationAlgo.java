...
/**
 * Older version of functions - for testing only
 */
@Deprecated
public class BaselineCalibrationAlgo {
     ...
     * @return Covariance matrix between 2 sets of joints (both sides of "matches" pair, accumulated).
     */
